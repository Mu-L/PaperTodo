...
- **待办关联纸片** — 把笔记纸拖到待办项上建立关联，之后可以直接打开目标纸片；关联模型也支持插件正文和其他待办纸。
...
**关联纸片**：可以把一张笔记纸从顶栏拖到待办项上建立关联。关联后，待办项后面会显示目标纸片的打开入口。
...
- **待办与纸片** — 完成后自动清除、关联纸片、显示名称、关联纸片显示长标题、已关联纸片是否显示为胶囊、关联脚本点击运行；高级另有自动压缩过大图片
